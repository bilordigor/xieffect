...
import { Box, InputBase, FormControlLabel, Switch, withStyles, Tooltip, Fab, BottomNavigation, BottomNavigationAction, Hidden, ClickAwayListener, AppBar, Toolbar, Typography, IconButton, Drawer, List, Avatar, Grid, Paper, Button, Divider, ListItem, ListItemIcon, ListItemText, MenuItem, MenuList, Grow, Popper, makeStyles, useTheme } from '@material-ui/core';
...
const Navigation = inject('store')(observer((props) => {
    ...
    return (
        <div className={classes.root}>
                                    ...
                                    >
                                        <Paper>
                                            <ClickAwayListener onClickAway={handleCloseExpandMore}>
                                                <MenuList autoFocusItem={openExpandMore} id="menu-list-grow" onKeyDown={handleListKeyDown} className={classes.menu}>
            ...
            {/* Левое боковое меню. Только Не для мобильной версии */}
            <Hidden only='xs'>
                <Drawer
                    variant="permanent"
                ...
                >
                    ...
                    <div className={classes.toolbar}>
                        <IconButton onClick={setClose} className={classes.iconsMenu}>
                    ...
                    <List>
                        {/* Аватар-профиль */}
                        <Link href="/profile" className={classes.aNavLink}>
            ...
            {/* Нижнее меню. Актуально для мобильной версии */}
            <Hidden smUp>
